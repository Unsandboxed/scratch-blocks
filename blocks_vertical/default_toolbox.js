...
Blockly.Blocks.defaultToolbox = '<xml id="toolbox-categories" style="display: none">' +
  ...
  '<category name="Extensions" id="extensions" colour="#FF6680" secondaryColour="#FF4D6A" ' +
    ...
    '<block type="extension_music_play_note" id="extension_music_play_note">' +
      ...
      '</value>' +
    '</block>' +
    '<block type="extension_vector_test_value" id="extension_vector_test_value">' +
      '<value name="VECTOR_A">' +
        '<shadow type="math_vector2">' +
          '<field name="VEC">0, 0</field>' +
        '</shadow>' +
      '</value>' +
      '<value name="VECTOR_B">' +
        '<shadow type="math_vector2">' +
      ...
      '</value>' +
    '</block>' +
    '<block type="extension_vector_test_input" id="extension_vector_test_input">' +
      '<value name="VECTOR">' +
        '<shadow type="math_vector2">' +
          '<field name="VEC">0, 0</field>' +
        '</shadow>' +
